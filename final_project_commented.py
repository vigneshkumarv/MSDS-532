"""
Final Project Topic 2: Analysis of carAd data set to determine the most influencial attributes when predicting vehicles price (Commented print statements version)
October 18, 2023
...
# print(carAd_model_fuel_body_type.info())

# Determine car colors to keep for analysis
# print(carAd_model_fuel_body_type.Color.unique())
...
# print(carAd_filtered.info())

# Perform null check
null_check = carAd_filtered.isnull()
